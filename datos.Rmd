...
[{geofaceteAR}](https://electorarg.github.io/geofaceteAR/): Códigos geográficos de Argentina y grillas para visulaización de datos *como si fueran mapas* (una versión ampliada del trabajo con información geográfica fue incorporada en `{geoAr}`).
